...
export const handlers = [
  ...
  rest.get(`http://${window.location.hostname}/api/v1/users/confirmation`, (req, res, ctx) => {
    return res(
      ctx.status(200),
  ...
  rest.get(`http://${window.location.hostname}/api/v1/user_type`, (req, res, ctx) => {
    return res(
      ctx.status(401),
      ctx.json(
        {
  ...
  rest.post(`http://${window.location.hostname}/api/v1/oauth/token`, (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json({ success: true })
    );
  ...
  rest.post(`http://${window.location.hostname}/api/v1/users/sign_up`, (req, res, ctx) => {
    return res(
      ctx.status(200),
  ...
  rest.post(`http://${window.location.hostname}/api/v1/users/password`, (req, res, ctx) => {
    return res(
      ctx.status(200),
  ...
  rest.post(`http://${window.location.hostname}/api/v1/users/confirmation`, (req, res, ctx) => {
    return res(
      ctx.status(200),
  ...
  rest.post(`http://${window.location.hostname}/api/v1/doctors/create_examination`, (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json({ status: {"message": "Email Activation request was sent successfully."} })
    );
  ...
  rest.get(`http://${window.location.hostname}/api/v1/doctors/search_user/`, (req, res, ctx) => {
    return res(
      ctx.status(200),
  ...
  rest.get(`http://${window.location.hostname}/api/v1/doctors/search_drug/`, (req, res, ctx) => {
    return res(
      ctx.status(200),
  ...
  rest.get(`http://${window.location.hostname}/api/v1/doctors/user_examinations/`, (req, res, ctx) => {
    return res(
      ctx.status(200),
  ...
  rest.get(`http://${window.location.hostname}/api/v1/patients/examinations`, (req, res, ctx) => {
